      ...
      @else
        ...
        <div class="card border-0 rounded-4 shadow-xs">
          <div class="card-header bg-white border-0 pt-4 pb-0 d-flex justify-content-between align-items-center">
            ...
            {{-- Nút Thêm thành viên (mời bằng email) --}}
                ...
                <div class="list-group-item px-4 py-3">
                  <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="text-secondary small">Tham gia {{ \Carbon\Carbon::parse($m->joined_at)->format('d/m/Y') }}</span>
                    </div>
                  </div>
                </div>
              @endforeach
...
{{-- MODAL: Thêm thành viên bằng username (chỉ render khi đã có org) --}}
@if(!empty($org))
