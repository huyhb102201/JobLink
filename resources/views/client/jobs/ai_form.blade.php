...
@push('styles')
  ...
  <style>
    ...
    .header-gradient {
      background: linear-gradient(135deg, #0f172a 0%, #1e293b 60%, #0b1730 100%) !important;
      color: #e5f0ff !important;
    }

    .header-primary {
      background: linear-gradient(135deg, #2563eb 0%, #3b82f6 45%, #06b6d4 100%) !important;
      color: #fff !important;
    }
    ...
    .skel input::placeholder,
    .skel textarea::placeholder {
      color: transparent !important;
    }
        ...
        <div class="row g-4">
          ...
          <div class="col-12 col-lg-7">
            <form id="jobForm" method="POST" action="{{ route('client.jobs.ai.submit') }}"
              class="card card-soft shadow h-100">
              @csrf
              ...
              <div class="card-body p-4" id="formBody">
                <div class="mb-3">
                  ...
                  <input name="title" id="f_title" class="form-control form-control-lg" placeholder="Tiêu đề ngắn gọn" required>
                </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input name="total_budget" id="f_budget_total" class="form-control" placeholder="Tự động tính toán" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row g-3 mt-1">
                  <div class="col-md-4">
                    <label class="form-label fw-semibold">Freelacer</label>
                    <div class="input-group">
                ...
                <div class="row g-3 mt-1">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input name="deadline" id="f_deadline" class="form-control"
                        placeholder="VD: 2025-11-30 hoặc +2 tuần" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="mt-3">
                  ...
                  <textarea name="description" id="f_description" rows="8" class="form-control"
                    placeholder="AI sẽ điền mô tả có cấu trúc. Bạn có thể chỉnh lại." required></textarea>
                </div>
              </div>
