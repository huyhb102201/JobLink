<nav class="sidebar bg-dark text-white p-3"
    style="width:320px; min-width:320px; max-width:320px; min-height:100vh; position: relative;">
    ...
    <ul class="nav flex-column" style="width: 100%;">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link text-white d-flex justify-content-between align-items-center {{ request()->is('admin/jobs*') || request()->is('admin/verifications*') ? 'active' : '' }}"
                data-bs-toggle="collapse" href="#verificationMenu" role="button"
            ...
            <div class="collapse {{ request()->is('admin/jobs*') || request()->is('admin/verifications*') ? 'show' : '' }}"
                id="verificationMenu">
                <ul class="nav flex-column ms-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white {{ request()->is('admin/withdrawals*') ? 'active' : '' }}"
                            href="{{ route('admin.withdrawals.index') }}"
                            style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            <i class="fa-solid fa-sack-dollar me-2"></i> Duyệt rút tiền
                        </a>
                    </li>
        ...
        <li class="nav-item mb-2">
            <a class="nav-link text-white d-flex justify-content-between align-items-center {{ request()->is('admin/payments*') || request()->is('admin/job-payments*') ? 'active' : '' }}"
                data-bs-toggle="collapse" href="#paymentMenu" role="button"
            ...
            <div class="collapse {{ request()->is('admin/payments*') || request()->is('admin/job-payments*') ? 'show' : '' }}"
                id="paymentMenu">
                <ul class="nav flex-column ms-3">
                    <li class="nav-item">
