            ...
            <div class="card shadow-sm h-100 hover-shadow">
                <div class="row g-0">
                    ...
                    <div class="col-md-4 d-flex justify-content-center align-items-center p-2">
                        <img src="{{ $job->image ?? asset('assets/img/blog/blog-1.jpg') }}" class="img-fluid rounded" alt="{{ $job->title }}">
                    </div>
                    <!-- Thông tin job -->
                    <div class="col-md-8">
                        <div class="card-body d-flex flex-column h-100">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <img src="{{ optional($job->account)->avatar_url ?? asset('assets/img/blog/blog-author.jpg') }}" alt="{{ optional($job->account)->name ?? 'Người đăng' }}" class="rounded-circle me-2" width="40" height="40">
                                <div>
                            ...
                            <div class="mt-3 d-flex justify-content-between align-items-center">
                                <a href="{{ route('jobs.show', $job->job_id) }}" class="btn btn-sm text-white" style="background-color: #0ea2bd; border-color: #0ea2bd;">Xem chi tiết</a>
                                <button class="btn p-0 text-danger fs-5 d-flex align-items-center justify-content-center" type="button">
